...
export default function BusinessManagerApp() {
  ...
  // --- ESTADOS PARA CARPETAS Y EXPANSIÓN DE HISTORIAL ---
  ...
  // --- AGRUPAMIENTO DINÁMICO DE VENTAS (SEMANA ACTUAL vs ARCHIVO AÑO/MES) ---
  const { currentWeekSales, archivedByYear } = useMemo(() => {
    ...
    sales.forEach((s) => {
      ...
      if (saleDate >= currentMonday) {
        ...
        if (!archived[year][monthName]) {
          archived[year][monthName] = [];
        }
  ...
  // --- RENDERIZADO REUTILIZABLE DE CADA TARJETA DE VENTA ---
      ...
      <main className="flex-1 overflow-y-auto p-4 md:p-8 bg-slate-950">
        ...
        {activeTab === 'dashboard' && (
          <div className="space-y-6">
            ...
            {/* HISTORIAL ORGANIZADO EN VENTAS DE LA SEMANA Y CARPETAS AÑO/MES */}
            <div className="bg-slate-900/90 border border-slate-800 rounded-3xl p-5 space-y-6 shadow-xl">
              ...
              {/* SECCIÓN 1: VENTAS DE LA SEMANA ACTUAL */}
              ...
              {/* SECCIÓN 2: CARPETAS HISTÓRICAS DE AÑOS Y MESES */}
